  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Sex skladlari',
        icon: Truck,
        roles: ['super_admin', 'pm', 'supply_manager'],
      },
      {
        path: '/central-warehouse',
        label: 'Markaziy sklad',
        icon: Warehouse,
        roles: ['super_admin', 'pm', 'central_warehouse_manager'],
      },
      {
        path: '/stores',
        label: "Do'konlar",
        icon: Store,
        roles: ['super_admin', 'pm', 'store_manager'],
      },
      {
        path: '/transfer',
        label: "O'tkazish",
        icon: ArrowLeftRight,
        roles: ['super_admin', 'pm', 'raw_warehouse_manager', 'production_manager', 'supply_manager', 'central_warehouse_manager'],
      },
      {
        path: '/replenishment',
      ...
      },
      {
        ...
        label: 'Sotuvlar',
        icon: ShoppingBag,
        roles: ['super_admin', 'pm', 'store_manager', 'central_warehouse_manager'],
      },
      {
      ...
      },
      {
        ...
        label: 'Nakladnoylar',
        icon: FileText,
        roles: ['super_admin', 'pm', 'store_manager', 'production_manager'],
      },
      {
        path: '/cashier/safe',
    ...
    items: [
      {
        ...
        label: 'Zayavkalar',
        icon: ClipboardList,
        roles: ['super_admin', 'pm', 'production_manager', 'central_warehouse_manager'],
      },
      {
        path: '/zagotovka',
        label: 'Zagotovka',
      ...
      {
        path: '/krem-kaymok',
        label: 'Krem kaymokchi',
        icon: Coffee,
        roles: ['super_admin', 'pm', 'production_manager'],
      },
      {
        path: '/warehouse-dispatch',
        label: 'Xomashyo berish',
        icon: Truck,
        roles: ['super_admin', 'pm', 'raw_warehouse_manager', 'production_manager'],
      },
      {
        path: '/production-cost-report',
        label: 'Ishlab chiqarish hisoboti',
        icon: BarChart2,
        roles: ['super_admin', 'pm', 'production_manager'],
      },
      {
        path: '/raw-materials-usage',
        label: 'Xomashyo iste\'moli',
        icon: FlaskConical,
        roles: ['super_admin', 'pm', 'production_manager'],
      },
      {
